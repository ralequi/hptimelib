...
int main (/*int argc, char **argv*/) {
	...
	printf (
	    "Configuring hptlib with precision=%hhu and default clockspeed=%lu (0 "
	    "means AUTO)\n",
	...
	printf ("Done! (Exactly waited %lu s, %lu ms, %lu us, %lu ns)\n",
	        dif / 1000000000, dif / 1000000 - (dif / 1000000000) * 1000,
	        dif / 1000 - (dif / 1000000) * 1000, dif - (dif / 1000) * 1000);
